...
const values: Value[] = [
  {
    ...
    text: "Every strategy starts with understanding your mission and the real problems you're solving for your audience. I dig deep to uncover what truly matters to your customers and how your brand can make a meaningful difference in their lives.",
  ...
  {
    title: "Heart-First",
    text: "Authentic connections come from genuine care. Your brand should reflect the passion behind your mission. I help you communicate with emotion, clarity, and care that resonates with your audience on a deeper level.",
  ...
  {
    title: "No Fluff",
    text: "Clear, compelling messaging that cuts through the noise and speaks directly to your audience's needs. No jargon. No BS. Just authentic communication that earns attention and drives real action.",
  ...
  {
    title: "High Impact",
    text: "Strategic thinking that drives real business results while staying true to your brand's core values. Every piece of content, every campaign, every touchpoint is engineered to convert and grow your business.",
                ...
                <CardContent className="p-0 h-full">
                  <div className="px-12 pt-8 pb-12 h-full flex flex-col">
                    ...
                    <div className="flex-1 flex flex-col">
                      ...
                      <p className="[font-family:'Inter',Helvetica] font-normal text-[#091329] text-[16px] tracking-[0] leading-[25.2px] pr-4 flex-1">
                        {value.text}
                      </p>
                    </div>
                  </div>
