              ...
              <div key={index} className={`h-6 sm:h-8 lg:h-9 w-16 sm:w-20 lg:${item.width}`}>
                <div className="h-full rounded-full">
                  <div className="w-full h-full rounded-full">
                    ...
                    >
                      <span className="[font-family:'Montserrat',Helvetica] font-normal text-black text-[16px] tracking-[0] leading-5 whitespace-nowrap hover:text-[#e44782] transition-colors duration-200">
                        {item.label}
                      </span>
                    </a>
                  </div>
