              ...
              <div className="pt-4 pb-6">
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="flex flex-col items-center mr-8 flex-shrink-0">
                      <div className="w-12 h-12 bg-[#F8F9FA] rounded-xl flex items-center justify-center">
                        <img src="/check-list-marketing.svg" alt="Check list" className="w-[40px] h-[40px]" style={{ filter: 'brightness(0) saturate(100%) invert(67%) sepia(99%) saturate(1234%) hue-rotate(60deg) brightness(101%) contrast(101%)' }} />
                      </div>
                    </div>
                  ...
                  <div className="flex items-start">
                    <div className="flex flex-col items-center mr-8 flex-shrink-0">
                      <div className="w-12 h-12 bg-[#F8F9FA] rounded-xl flex items-center justify-center">
                        <img src="/announcement-marketing.svg" alt="Announcement" className="w-[40px] h-[40px]" style={{ filter: 'brightness(0) saturate(100%) invert(67%) sepia(99%) saturate(1234%) hue-rotate(60deg) brightness(101%) contrast(101%)' }} />
                      </div>
                    </div>
                    <div className="flex-1 max-w-none">
                      <p className="text-gray-700 text-base leading-relaxed max-w-4xl">
                  ...
                  <div className="flex items-start">
                    <div className="flex flex-col items-center mr-8 flex-shrink-0">
                      <div className="w-12 h-12 bg-[#F8F9FA] rounded-xl flex items-center justify-center">
                        <img src="/eye-marketing.svg" alt="Eye" className="w-[40px] h-[40px]" style={{ filter: 'brightness(0) saturate(100%) invert(67%) sepia(99%) saturate(1234%) hue-rotate(60deg) brightness(101%) contrast(101%)' }} />
                      </div>
                    </div>
                    <div className="flex-1 max-w-none">
                      <p className="text-gray-700 text-base leading-relaxed max-w-4xl">
