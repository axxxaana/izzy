...
export const HomePage: React.FC = () => {
  return (
    <Layout 
      ...
      description="Fractional CMO and brand strategist helping femtech, healthtech and social-impact founders create bold, heart-felt brands that move people. Book a free brand strategy call."
    >
