          ...
          <div className="flex-1 flex flex-col items-center md:items-end justify-center py-16 pl-[50px] md:pl-[100px] lg:pl-[150px] xl:pl-[200px] 2xl:pl-[250px]">
            ...
            >
              ...
              >
                <Link 
                  to="/get-started"
                  className="inline-block bg-[#e44782] text-white border-2 border-[#e44782] rounded-[0.84rem] px-5 py-3 text-[20px] font-['Montserrat'] font-medium transition-all duration-300 ease-out shadow-[0_8px_25px_rgba(228,71,130,0.3)] hover:bg-white hover:text-[#e44782] hover:border-[#e44782] cursor-pointer no-underline box-border tracking-[1.2px]"
                >
                  Book a Call
                </Link>
              </motion.div>
