...
const features = [
  {
    icon: (
      <span className="flex items-center justify-center w-20 h-20 rounded-full bg-[#F8F9FA] mb-7 shadow group-hover:scale-110 group-hover:shadow-lg transition-transform duration-200">
        ...
        <img src="/heart.svg?v=2" alt="Heart" width="42" height="42" style={{ filter: 'brightness(0) saturate(100%) invert(65%) sepia(85%) saturate(800%) hue-rotate(60deg) brightness(95%) contrast(95%)' }} />
      </span>
    ),
  ...
  },
  {
    icon: (
      <span className="flex items-center justify-center w-20 h-20 rounded-full bg-[#F8F9FA] mb-7 shadow group-hover:scale-110 group-hover:shadow-lg transition-transform duration-200">
        ...
        <img src="/eye-marketing.svg?v=1" alt="Eye Marketing" width="42" height="42" style={{ filter: 'brightness(0) saturate(100%) invert(65%) sepia(85%) saturate(800%) hue-rotate(60deg) brightness(95%) contrast(95%)' }} />
      </span>
    ),
    title: "Ambitious",
  ...
  },
  {
    icon: (
      <span className="flex items-center justify-center w-20 h-20 rounded-full bg-[#F8F9FA] mb-7 shadow group-hover:scale-110 group-hover:shadow-lg transition-transform duration-200">
        ...
        <img src="/time.svg?v=3" alt="Time" width="42" height="42" style={{ filter: 'brightness(0) saturate(100%) invert(65%) sepia(85%) saturate(800%) hue-rotate(60deg) brightness(95%) contrast(95%)' }} />
      </span>
    ),
    title: "Time-Smart",
