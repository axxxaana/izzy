    ...
    <section className="w-full bg-gray-50 py-16 lg:py-24">
      <div className="max-w-6xl mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mt-16">
          ...
          <button className="bg-[#e44782] text-white font-['Montserrat'] text-base px-8 py-4 rounded-[0.84rem] hover:bg-white hover:text-[#e44782] hover:border-2 hover:border-[#e44782] transition-all duration-200" style={{ fontFamily: "Montserrat, Helvetica, Arial, sans-serif" }}>
            Let's Work Together
          </button>
        </div>
      </div>
